...
public class DeplacementJoueur : MonoBehaviour
{
    ...
    //    oDeplacementCarre = FindAnyObjectByType<DeplacementCarre>().gameObject;

        components = FindObjectsByType<DeplacementCarre>(FindObjectsSortMode.None);
        ...
        // if (!oDeplacementCarre)
        // {
        //     Debug.LogWarning("It worked sort of");
        // }
        // else
        // {
        //     DeplacementCarre();
    ...
    public void DeplacementCarre()
    {
        Debug.LogWarning("IT WORKED");


        foreach (DeplacementCarre oDeplacementCarre in components)
        {
             oDeplacementCarre.transform.position = new Vector2 
            (Random.Range (-8,8),Random.Range (-5,5));
        }
